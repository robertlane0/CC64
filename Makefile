...
.PHONY: all clean check test test-unit test-target test-bochs self-host selfhost-probe self-host-run fuzz-smoke repro-check check-release check-release-strict audit install-tools
all: cc64
...
check-release: check test-target test-bochs self-host selfhost-probe self-host-run fuzz-smoke repro-check audit
